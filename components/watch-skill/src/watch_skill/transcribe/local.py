...
from watch_skill.proc import hidden
...
def has_cuda_gpu() -> bool:
    ...
    try:
        result = subprocess.run(
            ...
            capture_output=True, text=True, timeout=15.0, **hidden(),
        )
...
def transcribe_local(
    ...
    configured = os.environ.get("WATCHSKILL_WHISPER_DEVICE") or get_settings().whisper_device
